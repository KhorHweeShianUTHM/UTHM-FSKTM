...
INSERT INTO `order_details` (`detail_id`, `order_id`, `quantity`, `price`) VALUES
(1, 1, 1, 1, 500),
(3, 3, 3, 1, 890);
...
CREATE TABLE `product` (
  ...
  `price` DOUBLE NOT NULL, -- Define price column as DOUBLE without parentheses
  `category_id` int(11) NOT NULL,
...
(1, 'V Neck Crop Top', '...', './uploads/v-neck.jpg', 500.00, 1, '2022-03-28'),
(2, 'Off Shoulder Crop Top', '...', './uploads/offshoulder.jpg', 890, 1.00, '2022-04-04'),
(3, 'Off Shoulder Tops', '...', './uploads/tops.jpg', 600, 1.00, '2022-04-04'),
(4, 'Printed Crop Top', '...', './uploads/croptop.jpg', 700, 1.00, '2022-04-04'),
(5, 'Shirtdress', '...', './uploads/shirtdress.jpg', 1850, 2.00, '2022-04-04'),
(6, 'Check Strappy Dress', '...', './uploads/check-strappy-dress.jpg', 1250, 2.00, '2022-03-24'),
(7, 'Floral Dress', '...', './uploads/dress.jpg', 1500, 2.00, '2022-04-04');
...
(2, 'Admin ', 'Admin', 'test@gmail.com', '$2y$10$DJOdhZy1InHTKQO6whfyJexVTZCDTlmIYGCXQiPTv7l82AdC9bWHO', '980098322', '2022-04-10', 0, 'matepani-12');
...
ALTER TABLE `cart`
  ...
  ADD UNIQUE KEY `uc_cart` (`user_id`),
