...
<body>
  <div class="sidebar">
    ...
    <ul class="menu-top">
      ...
      <li class="active"><a href="staff_customer.php"><i class="fas fa-users"></i> Customers</a></li>
      ...
      <li><a href="staff_analytics.php"><i class="fas fa-chart-line"></i> Analytics</a></li>
      <li><a href="staff_supplier.php"><i class="fas fa-boxes"></i> Suppliers</a></li>
      <li><a href="staff_setting.php"><i class="fas fa-cog"></i> Settings</a></li>
    </ul>
  </div>
  ...
  <div class="main">
    ...
    <div class="content">
      <div class="top-bar">
        <form method="GET" action="" style="display: flex; gap: 10px;">
          ...
          <button type="button" onclick="openModal()"><i class="fas fa-plus"></i> Add Customer</button>
        </form>
      </div>
    ...
    <div id="addCustomerModal" class="modal">
      <div class="modal-content">
        ...
        <form method="POST" action="staff_customer_add.php" id="customerForm">
    ...
    <div id="editCustomerModal" class="modal">
      <div class="modal-content">
        ...
        <form method="POST" action="staff_customer_update.php" id="editCustomerForm">
    ...
    <div id="deleteConfirmModal" class="modal">
      <div class="modal-content">
        ...
        <form method="POST" action="staff_customer_delete.php">
